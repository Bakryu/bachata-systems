...
const articles = [
  ...
  },
  {
    ...
    excerpt:
      'Learn how to create and maintain design systems that ensure consistency across large-scale applications.',
    category: 'Design',
  ...
  },
  {
    ...
    excerpt:
      'A comprehensive guide to selecting the perfect technology stack that will grow with your business.',
    category: 'Business',
  ...
  },
  {
    ...
    excerpt:
      'Discover how artificial intelligence is revolutionizing the way we build and maintain web applications.',
    category: 'Technology',
    author: 'Michael Chen',
    date: '2024-01-05',
    readTime: '7 min read',
  ...
  },
  {
    ...
    excerpt:
      "Learn proven strategies to improve your website's loading speed and overall performance.",
    category: 'Web Development',
    author: 'Michael Chen',
    date: '2024-01-03',
  ...
  },
  {
    ...
    excerpt:
      'Explore the psychology behind great UX design and how to create truly user-centered experiences.',
    category: 'Design',
    author: 'Emily Rodriguez',
    date: '2024-01-01',
    readTime: '9 min read',
...
const resources = [
  {
    ...
    description:
      'A comprehensive checklist to ensure your web projects meet all quality standards.',
    type: 'PDF Guide',
    icon: '📋',
    downloadUrl: '#',
  },
...
export default function ResourcesPage() {
  ...
  return (
    <>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <Typography
                        variant="caption"
                        component="span"
                        className="px-2 py-1 bg-white/90 text-charcoal-700 rounded"
                      >
                        {article.category}
                      </Typography>
                    </div>
      ...
      {/* Free Resources */}
      <Section id="resources" padding="lg">
        <ScrollReveal>
          <div className="text-center mb-16">
            <Typography variant="h2" align="center" className="mb-4">
              Free Resources
      ...
      >
        <ScrollReveal>
          <div className="text-center">
            ...
            >
              Subscribe to our newsletter and get the latest insights, resources, and updates
